...
/**
 * reference: https:// blog.csdn.net/xietansheng/article/details/72862660
 */
public class Group {
    public static void main(String[] args) {
        ...
        GroupLayout.ParallelGroup hParalGroup = layout.createParallelGroup().addGroup(hSeqGroup).addComponent(btn05,
        ...
        GroupLayout.SequentialGroup vSeqGroup = layout.createSequentialGroup().addGroup(vParalGroup01)
                .addGroup(vParalGroup02).addComponent(btn05);
