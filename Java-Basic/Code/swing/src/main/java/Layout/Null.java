...
/**
 * https:// blog.csdn.net/xietansheng/article/details/72862726
 */
public class Null {
    public static void main(String[] args) {
         ...
         *
         * PS_01: jf.setVisible(true) 之后，内容面板才有宽高; PS_02: 使用其他布局时, jf.setVisible(true)
         * 之后添加的组件, 也会被当做是绝对布局来布置该组件（即需要手动指定坐标和宽高）; PS_03: 使用其他布局时, jf.setVisible(true)
         * 之前添加的组件, 如果在 jf.setVisible(true) 之后手动设置该组件的坐标和宽高,
